    ...
    void FixedUpdate()
{
    ...
    public IEnumerator DipVolume(GameObject gameObject)
    {
        ...
        villainObj.GetComponent<VillainSprite>().FadeOut();
        yield return null;
    }
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        switch(trackName)
        {
            ...
            case "DragonLine_1":
                ...
                {
                    Debug.Log("Entered Trigger");
                    villainObj.GetComponent<VillainSprite>().FadeIn();
            ...
            case "RockTrigger":
                if (roc_1 == false)
                {
                    EventManager.ThrowRockEvent();
                    roc_1  = true;
                }
                break;
            case "WinGame":
                winGame.GetComponent<WinGame>().TurnOnUI();
                break;
            default:
                break;
        }
